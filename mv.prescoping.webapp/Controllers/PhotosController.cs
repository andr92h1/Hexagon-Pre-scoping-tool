...
namespace mv.prescoping.webapp.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        // GET: api/Photos
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Photo>>> GetPhotos(int? code, string status = null)
        {
            ...
            return await _context.Photos.Where(x => (code == null || x.Code == code) && (status == null || x.Status == status)).ToListAsync();
        }
