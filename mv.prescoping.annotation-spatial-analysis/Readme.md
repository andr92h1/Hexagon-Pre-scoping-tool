...
Execute unit tests
```
    cd "mv.prescoping.annotation-spatial-analysis/test/mv.prescoping.annotation-spatial-analysis.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "mv.prescoping.annotation-spatial-analysis/src/mv.prescoping.annotation-spatial-analysis"
